describe("createTable", function () {
 ...
 describe("selecting cells", function () {
   ...
   it("Check up edge case", function () {
     ...
     let event = new KeyboardEvent('keydown', {bubbles: true, keyCode: '38'})
     document.dispatchEvent(event)
   ...
   it("Check down edge case", function () {
     ...
     // Select A30
     A30.dispatchEvent(new Event('click', {bubbles: true}))
   ...
   it("Check right edge case", function () {
     ...
     // Select A30
     Z30.dispatchEvent(new Event('click', {bubbles: true}))
     // Simulate clicking down key down
     let event = new KeyboardEvent('keydown', {bubbles: true, keyCode: '39'})
     document.dispatchEvent(event)
